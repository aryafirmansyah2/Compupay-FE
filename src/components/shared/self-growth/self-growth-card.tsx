...
interface SelfGrowthCardProps extends ComponentProps<'div'> {
  title: string;
  period?: string;
  action?: ReactNode;
...
export function SelfGrowthCard({
  title,
  period,
  action,
  children,
...
interface SelfGrowthTabsCardProps extends ComponentProps<'div'> {
  title: string;
  period?: string;
...
export function SelfGrowthTabsCard({
  title,
  period,
...
export function SelfGrowthCardActionsDropdown({
  children,
  ...props
...
export function SelfGrowthActionsTabs() {
  return (
...
export function SelfGrowthActionsSelect() {
  return (
    <div className="-mt-2 -me-2">
