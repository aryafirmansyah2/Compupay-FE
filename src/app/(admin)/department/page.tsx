...
import DialogFormDepartment from "./_components/dialog-form-department";
import { columns } from "./_components/column-table-department";
...
export default function DepartmentPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    setError(null);
    try {
      const res = await request.get(`/department?search=${search}`);
      ...
      <OurCard
        ...
        action={
          <div className="flex gap-4">
            ...
            <DialogFormDepartment type="create" fetchData={fetchData}>
